...
- Track URI手動登録で album URL / URI を入力した場合、同じアルバム内のローカル曲へ Spotify track URI を一括登録
...
- `Auto Set Track URI from Album`: 選択内のアルバムごとに Spotify album を検索し、同じローカルアルバムへ Spotify track URI を一括登録
